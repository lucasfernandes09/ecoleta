...
public class PontoDeColetaActivity extends AppCompatActivity {
    ...
    private String nomeEntidade, endereco, numero;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //referenciação
        etNomeEntidade = findViewById(R.id.etNomeEntidade);etEndereco = findViewById(R.id.etEndereco);etNumero = findViewById(R.id.etNumero);
        spnEstados = findViewById(R.id.spnEstados);spnCidades = findViewById(R.id.spnCidades);
    ...
    private Boolean validarCampos() {
        nomeEntidade = etNomeEntidade.getText().toString();
